...
export type GetCurrentUserInfoQuery = { __typename?: 'Query', currentUser: { __typename?: 'User', id: string, name: string }, messages: Array<{ __typename?: 'Message', id: string, text: string, createdAt: any, senderId: string, senderName: string }> };
